...
interface NotificationRequest {
  to: string;
  type: 'order_completed' | 'order_cancelled' | 'buyer_approved' | 'buyer_rejected';
  bookingId?: string;
  reason?: string;
  buyerName?: string;
}
...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    const { to, type, bookingId, reason, buyerName }: NotificationRequest = await req.json();
    ...
    if (type === 'order_completed') {
      ...
      `;
    } else if (type === 'buyer_approved') {
      subject = "✅ Congratulations! Your Scrap Buyer Account Has Been Approved";
      htmlContent = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: linear-gradient(135deg, #10b981, #059669); color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
          ...
          <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px;">
            <h2 style="color: #1f2937; margin-top: 0;">Welcome Aboard, ${buyerName}!</h2>
            <p style="color: #4b5563; font-size: 16px; line-height: 1.6;">
              Great news! Your scrap buyer account has been approved by our team. You can now start accepting scrap collection orders.
            </p>
            <div style="background: #10b981; color: white; padding: 20px; border-radius: 8px; margin: 20px 0;">
              <h3 style="margin: 0 0 10px 0;">🚀 What you can do now:</h3>
              <ul style="margin: 0; padding-left: 20px;">
                <li>View available scrap pickup orders in your area</li>
                <li>Accept and complete orders</li>
                <li>Track your earnings and statistics</li>
                <li>Build your reputation with our customers</li>
              </ul>
            </div>
            <div style="text-align: center; margin: 30px 0;">
              <a href="https://wascrap.com/dashboard" style="background: #10b981; color: white; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block;">
                Go to Dashboard
              </a>
            </div>
            <p style="color: #4b5563; font-size: 16px; line-height: 1.6;">
              We're excited to have you as part of our network. Together, we're making a positive impact on the environment!
            </p>
            <div style="text-align: center; margin-top: 30px;">
              <p style="color: #6b7280; font-size: 14px;">
                Questions? Contact us at support@wascrap.com
      ...
      `;
    } else if (type === 'buyer_rejected') {
      subject = "❌ Update on Your Scrap Buyer Application";
      htmlContent = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: linear-gradient(135deg, #ef4444, #dc2626); color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
          ...
          <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px;">
            <h2 style="color: #1f2937; margin-top: 0;">Dear ${buyerName},</h2>
            <p style="color: #4b5563; font-size: 16px; line-height: 1.6;">
              Thank you for your interest in becoming a scrap buyer with WaScrap. After careful review of your application, we regret to inform you that we are unable to approve your account at this time.
            </p>
            <div style="background: #fef2f2; border: 1px solid #fecaca; color: #991b1b; padding: 20px; border-radius: 8px; margin: 20px 0;">
              <h3 style="margin: 0 0 10px 0;">📋 Reason:</h3>
              <p style="margin: 0; font-weight: 500;">${reason || 'Application did not meet our current requirements'}</p>
            </div>
            <div style="background: #3b82f6; color: white; padding: 20px; border-radius: 8px; margin: 20px 0;">
              ...
              <ul style="margin: 0; padding-left: 20px;">
                ...
                <li>Ensure all required documents are valid and clear</li>
                <li>Reapply after addressing the concerns</li>
                <li>Contact our support team for clarification</li>
              </ul>
            </div>
            <p style="color: #4b5563; font-size: 16px; line-height: 1.6;">
              We appreciate your interest in joining our platform. If you believe this decision was made in error or would like more information, please don't hesitate to reach out to our support team.
            </p>
            <div style="text-align: center; margin-top: 30px;">
              <p style="color: #6b7280; font-size: 14px;">
                Questions? Contact us at support@wascrap.com or call us at +91-XXXXXXXXXX
